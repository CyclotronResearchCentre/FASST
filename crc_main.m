...
disp('															  ');
disp(' Automatic sleep scoring powered by Neurobit PSG.			  ');
disp('															  ');
disp(' Cite this version as:                                      ');
disp(' Neurobit PSG, Neurobit Inc. New York, USA.                 ');
disp(' and Choo et al., Frontiers in Neurology, Volume 14, 2023   ');
...
str{10}='Doroth�e Coppieters, d.coppieters@ulg.ac.be';
